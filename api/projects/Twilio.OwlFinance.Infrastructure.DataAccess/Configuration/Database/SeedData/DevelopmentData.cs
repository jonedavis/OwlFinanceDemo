    ...
    internal static class DevelopmentData
    {
        ...
        private static void SeedAgents(OwlFinanceDbContext context)
        {
            ...
            context.Agents.AddOrUpdate(
                ...
                new[] {
                    new Agent {
                        IdentityID = "auth0|5769b9ca1619cd54130ee2c5",
                        FirstName = "Kevin",
                        LastName = "Babcock",
                        SID = "WK5dfaa46feaa0378161ccd63da9981f18",
                        CreatedDate = now,
                        ModifiedDate = now
                    },
                    new Agent {
                        IdentityID = "auth0|5727c6ca0933b72c0ac9204e",
                        FirstName = "Venkata",
                        LastName = "Koppaka",
                        SID = "WK1de4320c627b5a553fa5fd9d29903d27",
                        CreatedDate = now,
                        ModifiedDate = now
                    },
                    new Agent {
                        IdentityID = "auth0|573e7678e752aa496ccfc427",
                        FirstName = "Jon",
                        LastName = "Davis",
                        SID = "WKe7572ca7aa2ea997a257cea0cdb532da",
                        CreatedDate = now,
                        ModifiedDate = now
                    }
                }
        ...
        private static void SeedCustomers(OwlFinanceDbContext context)
        {
            ...
            var customer1 = new Customer {
                IdentityID = "auth0|5743356f501b496a47dca83e",
                FirstName = "Al",
                LastName = "Cook",
                ImagePath = "acook.png",
                Address = address1,
            ...
            var customer2 = new Customer {
                IdentityID = "auth0|57855e606e3127094e540912",
                FirstName = "Peter",
                LastName = "Tan",
                ImagePath = "ptan.png",
                Address = address2,
            ...
            var customer3 = new Customer {
                IdentityID = "auth0|57855e866e3127094e54091e",
                FirstName = "Peter",
                LastName = "Lee",
                ImagePath = "plee.png",
                Address = address3,
        ...
        {
            var now = DateTime.UtcNow;
            var customer1 = context.Customers.SingleOrDefault(c => c.IdentityID == "auth0|5743356f501b496a47dca83e");
            var customer2 = context.Customers.SingleOrDefault(c => c.IdentityID == "auth0|57855e606e3127094e540912");
            var customer3 = context.Customers.SingleOrDefault(c => c.IdentityID == "auth0|57855e866e3127094e54091e");
        ...
        {
            var now = DateTime.UtcNow;
            var agent1 = context.Agents.SingleOrDefault(e => e.IdentityID == "auth0|5769b9ca1619cd54130ee2c5");
            var agent2 = context.Agents.SingleOrDefault(e => e.IdentityID == "auth0|5727c6ca0933b72c0ac9204e");
            var agent3 = context.Agents.SingleOrDefault(e => e.IdentityID == "auth0|573e7678e752aa496ccfc427");
