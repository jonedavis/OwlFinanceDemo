    ...
    internal static class ProductionData
    {
        ...
        private static void SeedAgents(OwlFinanceDbContext context)
        {
            ...
            context.Agents.AddOrUpdate(
                ...
                new[] {
                    new Agent {
                        IdentityID = "auth0|576c4b0b5a4e3380356087f5",
                        FirstName = "Jon",
                        LastName = "Davis",
                        SID = "WKbc5e75755b57930caefb84da9d1e94cb",
                        CreatedDate = now,
                        ModifiedDate = now
                    },
                    new Agent {
                        IdentityID = "auth0|576c4b7d1696a0662d2d2d40",
                        FirstName = "Sophie",
                        LastName = "Asher",
                        SID = "WKff38d6d6bb732ceb9b86822806c06797",
                        CreatedDate = now,
                        ModifiedDate = now
                    },
                    new Agent {
                        IdentityID = "auth0|576c4baa1696a0662d2d2d4b",
                        FirstName = "Elisa",
                        LastName = "Bellagamba",
                        SID = "WKb519d1dd14c73ee08a38afc0ffc08071",
                        CreatedDate = now,
                        ModifiedDate = now
                    }
                }
        ...
        private static void SeedCustomers(OwlFinanceDbContext context)
        {
            ...
            var customer1 = new Customer {
                IdentityID = "auth0|576c4b3e5a4e338035608814",
                FirstName = "Al",
                LastName = "Cook",
                ImagePath = "acook.png",
                Address = address1,
            ...
            var customer2 = new Customer {
                IdentityID = "auth0|576c4bd91696a0662d2d2d5d",
                FirstName = "Peter",
                LastName = "Tan",
                ImagePath = "ptan.png",
                Address = address2,
            ...
            var customer3 = new Customer {
                IdentityID = "auth0|576c4bfd1696a0662d2d2d6e",
                FirstName = "Peter",
                LastName = "Lee",
                ImagePath = "plee.png",
                Address = address3,
        ...
        {
            var now = DateTime.UtcNow;
            var customer1 = context.Customers.SingleOrDefault(c => c.IdentityID == "auth0|576c4b3e5a4e338035608814");
            var customer2 = context.Customers.SingleOrDefault(c => c.IdentityID == "auth0|576c4bd91696a0662d2d2d5d");
            var customer3 = context.Customers.SingleOrDefault(c => c.IdentityID == "auth0|576c4bfd1696a0662d2d2d6e");
        ...
        {
            var now = DateTime.UtcNow;
            var agent1 = context.Agents.SingleOrDefault(e => e.IdentityID == "auth0|576c4b0b5a4e3380356087f5");
            var agent2 = context.Agents.SingleOrDefault(e => e.IdentityID == "auth0|576c4b7d1696a0662d2d2d40");
            var agent3 = context.Agents.SingleOrDefault(e => e.IdentityID == "auth0|576c4baa1696a0662d2d2d4b");
